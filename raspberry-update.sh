...
sendemail -l email.log -f "$FROMEMAIL" -u "$PISERIAL-wave.log-$TIMESTAMP" -t "$TOEMAIL" -s "smtp.gmail.com:587" -o tls=yes -xu "$FROMEMAIL" -xp "$EMAILPASSWORD" -o message-file="/var/log/wave.log"
